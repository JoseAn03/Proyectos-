# 🗄️ SQL Portfolio — Reservation System Analysis
...
| **🎯** | [`portfolio_completo.sql`](./portfolio_completo.sql) | **All-in-one:** DDL + 200+ records + all queries | *Everything above* |
...
**Prerequisites:** MySQL 8.0+ or MariaDB 10.5+ · No external dependencies
...
**Jose Andres Sequeira Hernandez** · [LinkedIn](https://linkedin.com/in/joseandres-sequeira-hernandez-3aaa03285) · [GitHub](https://github.com/JoseAn03)
